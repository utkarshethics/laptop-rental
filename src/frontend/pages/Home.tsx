...
const FEATURED_PRODUCTS = [
  {
    ...
    brand: 'HP',
    category: 'laptop',
    images: [{ url: '/assets/products/hp/elitebook-840-g9/hero.svg', alt: 'HP EliteBook 840 G9', isPrimary: true }],
    pricing: { daily: 499, monthly: 8999 },
    rating: 4.8,
    reviewCount: 124,
  ...
  },
  {
    ...
    brand: 'Dell',
    category: 'laptop',
    images: [{ url: '/assets/products/dell/latitude-5430/hero.svg', alt: 'Dell Latitude 5430', isPrimary: true }],
    pricing: { daily: 449, monthly: 7999 },
    rating: 4.7,
    reviewCount: 98,
  ...
  },
  {
    ...
    brand: 'Apple',
    category: 'laptop',
    images: [{ url: '/assets/products/apple/macbook-air-m2/hero.svg', alt: 'MacBook Air M2', isPrimary: true }],
    pricing: { daily: 799, monthly: 14999 },
    rating: 4.9,
    reviewCount: 210,
  ...
  },
  {
    ...
    brand: 'Lenovo',
    category: 'laptop',
    images: [{ url: '/assets/products/lenovo/thinkpad-x1-carbon/hero.svg', alt: 'ThinkPad X1 Carbon', isPrimary: true }],
    pricing: { daily: 699, monthly: 12999 },
    rating: 4.8,
    reviewCount: 156,
