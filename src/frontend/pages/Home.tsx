...
const FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    brand: 'HP',
    category: 'laptop',
    images: [{ url: '/assets/products/hp/spectre-x360-14/hero.jpg', alt: 'HP Spectre x360 14', isPrimary: true }],
    pricing: { monthly: 1249 },
    rating: 4.8,
    reviewCount: 84,
    availability: { inStock: 9, cities: ['Bangalore', 'Mumbai', 'Delhi', 'Pune'] },
    featured: true,
  },
  {
    id: '14',
    ...
    brand: 'MSI',
    category: 'laptop',
    images: [{ url: '/assets/products/msi/gf63-thin/hero.jpg', alt: 'MSI GF63 Thin', isPrimary: true }],
    pricing: { monthly: 1099 },
    rating: 4.5,
    reviewCount: 76,
    availability: { inStock: 11, cities: ['Bangalore', 'Mumbai', 'Delhi', 'Hyderabad'] },
    featured: true,
  },
];
