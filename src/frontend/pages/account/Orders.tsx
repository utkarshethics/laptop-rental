...
const MOCK_ORDERS: Order[] = [
  {
    ...
    subtotal: 5499, discount: 0, tax: 0, deposit: 5000, total: 10499, currency: 'INR',
    ...
    payment: { method: 'card', status: 'completed', transactionId: 'txn_123', paidAt: '2024-01-15T10:30:00Z', amount: 10499 },
  ...
  },
  {
    ...
    items: [
      { id: '2', productId: '3', productName: 'MacBook Air M2', productImage: '/assets/products/apple/macbook-air-m2/hero.jpg', brand: 'Apple', quantity: 1, rentalPeriod: 'monthly', unitPrice: 8999, totalPrice: 8999 },
    ],
    subtotal: 8999, discount: 1500, tax: 0, deposit: 10000, total: 17499, currency: 'INR',
    shippingAddress: { name: 'John Doe', phone: '9876543210', email: 'john@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' },
    billingAddress: { name: 'John Doe', phone: '9876543210', email: 'john@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' },
    payment: { method: 'upi', status: 'completed', transactionId: 'txn_456', paidAt: '2023-12-01T14:20:00Z', amount: 17499 },
  ...
  },
  {
    ...
    subtotal: 3999, discount: 0, tax: 0, deposit: 5000, total: 8999, currency: 'INR',
    shippingAddress: { name: 'John Doe', phone: '9876543210', email: 'john@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' },
    billingAddress: { name: 'John Doe', phone: '9876543210', email: 'john@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' },
    payment: { method: 'card', status: 'refunded', transactionId: 'txn_789', paidAt: '2023-11-15T09:15:00Z', amount: 8999 },
