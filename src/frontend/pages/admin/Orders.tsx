...
const MOCK_ORDERS: Order[] = [
  { id: 'ORD-2024-001', userId: '1', status: 'active', items: [{ id: '1', productId: '1', productName: 'HP EliteBook 840 G9', productImage: '/assets/products/hp/elitebook-840-g9/hero.jpg', brand: 'HP', quantity: 1, rentalPeriod: 'monthly', unitPrice: 4499, totalPrice: 5499 }], subtotal: 4499, discount: 0, tax: 0, deposit: 4000, total: 8499, currency: 'INR', shippingAddress: { name: 'Rahul Sharma', phone: '9876543210', email: 'rahul@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' }, billingAddress: { name: 'Rahul Sharma', phone: '9876543210', email: 'rahul@example.com', line1: '123 Main St', city: 'Bangalore', state: 'Karnataka', pincode: '560001', country: 'India' }, payment: { method: 'card', status: 'completed', transactionId: 'txn_123', paidAt: '2024-01-15T10:30:00Z', amount: 8499 }, rentalStartDate: '2024-01-16', rentalEndDate: '2024-02-15', createdAt: '2024-01-15T10:30:00Z', updatedAt: '2024-01-20T14:20:00Z' },
  { id: 'ORD-2024-002', userId: '2', status: 'delivered', items: [{ id: '2', productId: '3', productName: 'MacBook Air M2', productImage: '/assets/products/apple/macbook-air-m2/hero.jpg', brand: 'Apple', quantity: 1, rentalPeriod: 'monthly', unitPrice: 6499, totalPrice: 8999 }], subtotal: 6499, discount: 1500, tax: 0, deposit: 8000, total: 12999, currency: 'INR', shippingAddress: { name: 'Priya Patel', phone: '9876543211', email: 'priya@example.com', line1: '456 Park Ave', city: 'Mumbai', state: 'Maharashtra', pincode: '400001', country: 'India' }, billingAddress: { name: 'Priya Patel', phone: '9876543211', email: 'priya@example.com', line1: '456 Park Ave', city: 'Mumbai', state: 'Maharashtra', pincode: '400001', country: 'India' }, payment: { method: 'upi', status: 'completed', transactionId: 'txn_456', paidAt: '2024-01-10T14:20:00Z', amount: 12999 }, rentalStartDate: '2024-01-11', rentalEndDate: '2024-02-10', createdAt: '2024-01-10T14:20:00Z', updatedAt: '2024-01-11T09:00:00Z' },
  { id: 'ORD-2024-003', userId: '3', status: 'processing', items: [{ id: '3', productId: '2', productName: 'Dell Latitude 5430', productImage: '/assets/products/dell/latitude-5430/hero.jpg', brand: 'Dell', quantity: 1, rentalPeriod: 'monthly', unitPrice: 3499, totalPrice: 3999 }], subtotal: 3499, discount: 0, tax: 0, deposit: 3000, total: 6499, currency: 'INR', shippingAddress: { name: 'Amit Kumar', phone: '9876543212', email: 'amit@example.com', line1: '789 Lake Rd', city: 'Delhi', state: 'Delhi', pincode: '110001', country: 'India' }, billingAddress: { name: 'Amit Kumar', phone: '9876543212', email: 'amit@example.com', line1: '789 Lake Rd', city: 'Delhi', state: 'Delhi', pincode: '110001', country: 'India' }, payment: { method: 'netbanking', status: 'completed', transactionId: 'txn_789', paidAt: '2024-01-18T09:15:00Z', amount: 6499 }, rentalStartDate: '2024-01-19', rentalEndDate: '2024-02-18', createdAt: '2024-01-18T09:15:00Z', updatedAt: '2024-01-18T09:15:00Z' },
  { id: 'ORD-2024-004', userId: '4', status: 'confirmed', items: [{ id: '4', productId: '4', productName: 'Lenovo ThinkPad X1 Carbon', productImage: '/assets/products/lenovo/thinkpad-x1-carbon/hero.jpg', brand: 'Lenovo', quantity: 1, rentalPeriod: 'monthly', unitPrice: 4999, totalPrice: 6499 }], subtotal: 4999, discount: 0, tax: 0, deposit: 5000, total: 9999, currency: 'INR', shippingAddress: { name: 'Sneha Singh', phone: '9876543213', email: 'sneha@example.com', line1: '321 Hill St', city: 'Hyderabad', state: 'Telangana', pincode: '500001', country: 'India' }, billingAddress: { name: 'Sneha Singh', phone: '9876543213', email: 'sneha@example.com', line1: '321 Hill St', city: 'Hyderabad', state: 'Telangana', pincode: '500001', country: 'India' }, payment: { method: 'card', status: 'completed', transactionId: 'txn_012', paidAt: '2024-01-19T16:20:00Z', amount: 9999 }, rentalStartDate: '2024-01-20', rentalEndDate: '2024-02-19', createdAt: '2024-01-19T16:20:00Z', updatedAt: '2024-01-19T16:20:00Z' },
  { id: 'ORD-2024-005', userId: '5', status: 'pending', items: [{ id: '5', productId: '5', productName: 'ASUS ROG Zephyrus G14', productImage: '/assets/products/asus/rog-zephyrus-g14/hero.jpg', brand: 'ASUS', quantity: 1, rentalPeriod: 'monthly', unitPrice: 6499, totalPrice: 8999 }], subtotal: 6499, discount: 0, tax: 0, deposit: 10000, total: 16499, currency: 'INR', shippingAddress: { name: 'Vikram Jain', phone: '9876543214', email: 'vikram@example.com', line1: '654 Valley Rd', city: 'Chennai', state: 'Tamil Nadu', pincode: '600001', country: 'India' }, billingAddress: { name: 'Vikram Jain', phone: '9876543214', email: 'vikram@example.com', line1: '654 Valley Rd', city: 'Chennai', state: 'Tamil Nadu', pincode: '600001', country: 'India' }, payment: { method: 'upi', status: 'pending', transactionId: 'txn_345', paidAt: '', amount: 16499 }, rentalStartDate: '2024-01-21', rentalEndDate: '2024-02-20', createdAt: '2024-01-19T14:10:00Z', updatedAt: '2024-01-19T14:10:00Z' },
];
